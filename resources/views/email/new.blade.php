    ...
    <table class="body">
      <tr>
        <td class="center" align="center" valign="top">
          <center>
            <table class="row" bgcolor="#F44336">
                    <tr>
                      <td class="header-wrap">
                        <table class="twelve columns">
                          <tr>
                            <td>
                            <h2 class="center header-text">IV Gainesville</h2>
                            </td>
